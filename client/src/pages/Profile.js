...
// new -- importing thoughtlist components and user queries from utils
...
// new -- after importing the updated thoughtlist component (with profile links) and user profile query
    // const Profile = () => {
    //   const { username: userParam } = useParams();
    //   const { loading, data } = useQuery(QUERY_USER, {
    //     variables: { username: userParam }
